...
public class Travels {
  ...
  static {
    Travels.IMG_DESCRIPTIONS.add(new Travels.Data("Potala Palace", "src1.png",
    ...
    Travels.IMG_DESCRIPTIONS.add(new Travels.Data("Zhangmu Port", "src6.png",
    ...
    Travels.IMG_DESCRIPTIONS.add(new Travels.Data("Drepung Monastery", "src2.png",
    ...
    Travels.IMG_DESCRIPTIONS.add(new Travels.Data("Sera Monastery", "src3.png",
    ...
    Travels.IMG_DESCRIPTIONS.add(new Travels.Data("Samye Monastery", "src4.png",
    ...
    Travels.IMG_DESCRIPTIONS.add(
        new Travels.Data("Tashilunpo Monastery", "src5.png",
